...
estimated_hours: 55
prerequisites: [series-1, series-2-partial, series-13]
tags: [climate, feedbacks, carbon-budget, atmospheric-inversion, remote-sensing, scenarios]
---

## Series Overview

Series 13 taught individual GHG processes — combustion, photosynthesis, methanogenesis. This series couples those processes into a full climate system. We move from component budgets to feedbacks, from bottom-up inventories to top-down atmospheric inversions, from current observations to future scenarios. The central question: given what we can measure, what can we say with confidence about how the climate system will evolve?

## Pedagogical Philosophy

**Series 13 taught components. Series 14 teaches coupling and feedbacks.** Students must understand individual GHG processes before tackling coupled climate-carbon dynamics.

**Mass balance as fundamental framework.** Every GHG budget follows: Sources − Sinks = Atmospheric Change. This principle connects disparate processes.

**Uncertainty is quantifiable.** Every flux has error bars. Monte Carlo propagation, not point estimates.

**Observation + modelling synergy.** Atmospheric measurements provide top-down constraint. Process models provide bottom-up estimates. Reconciliation reveals knowledge gaps.

**Tipping points and feedbacks.** Permafrost thaw, ocean carbon saturation, wetland emissions — positive feedbacks that could accelerate warming beyond simple projections.

## Learning Objectives

1. **Construct complete carbon budgets** from fossil fuels, land use, ocean, and atmosphere
2. **Build national GHG inventories** by sector using IPCC methods
3. **Estimate land use change emissions** from remote sensing and carbon stocks
4. **Quantify methane sources** from wetlands, agriculture, fossil fuels, and permafrost
5. **Model permafrost feedbacks** and project emissions under warming scenarios
6. **Apply inverse modelling** to infer fluxes from atmospheric observations
7. **Interpret satellite GHG measurements** to detect emission hotspots
8. **Quantify carbon-climate feedbacks** and feedback strength parameters
...
**Cluster AM:** Mass balance closure, uncertainty propagation, bottom-up accounting

**Cluster AN:** Budget construction, Q₁₀ temperature functions, positive feedback dynamics

**Cluster AP:** Bayesian inversion, transport modelling, spectroscopy fundamentals

**Cluster AQ:** Feedback parameter estimation, simple climate model integration, scenario analysis
...
1. **Mass balance reveals gaps.** Residual terrestrial sink highlights major uncertainty in the carbon cycle.

2. **Methane acceleration is worrying.** Post-2007 growth not fully explained; atmospheric inversions and isotopic data provide key constraints.

3. **Permafrost is a tipping point.** Contains 2× atmospheric carbon; thaw emissions poorly constrained but potentially catastrophic.

4. **Observations constrain models.** Top-down atmospheric measurements are essential for validating bottom-up inventories — neither alone is sufficient.

5. **Feedbacks amplify forcing.** Positive carbon-climate feedbacks could add 20–40% to emissions by 2100, compounding human emissions.

6. **Uncertainty is large but bounded.** Wetland CH₄ uncertain ±50%, permafrost feedback by factor of 3. Science must communicate this honestly.

7. **Multiple GHGs matter.** CH₄ short-lived but potent; N₂O small but persistent. CO₂-equivalent accounting is essential.

8. **Attribution is quantitative.** Isotopes, inversions, and remote sensing together separate natural vs anthropogenic, fossil vs biogenic.

## Applications

- National climate reporting (UNFCCC)
- Carbon offset verification
- Deforestation monitoring (REDD+)
- Agricultural emissions reduction programmes
- Methane leak detection (oil and gas industry)
- Climate policy evaluation
- Carbon budget tracking (Paris Agreement targets)
- Tipping point early warning systems
